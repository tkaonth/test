...
$menuItems = [
    ...
    [
        ...
        'subMenuItems' => [
            ...
            [
                'menu-name' => 'report-sub',
                'label' => 'Customer Follow-up Report Car Seized',
                'url' => 'usermanage',
            ],
            [
                'menu-name' => 'report-sub',
    ...
    [
        ...
        'subMenuItems' => [
            [
                ...
                'label' => 'User Level Manager',
                'url' => 'userlevelmanage',
            ],
            [
                'menu-name' => 'setting-sub',
                'label' => 'Customer Status Manager',
                'url' => 'customerstatus',
            ],
            [
                'menu-name' => 'setting-sub',
                'label' => 'Car Status Manager',
                'url' => 'carstatus',
            ],
            [
                'menu-name' => 'setting-sub',
                'label' => 'Bill Status Manager',
                'url' => 'billstatus',
            ],
            [
                'menu-name' => 'setting-sub',
                'label' => 'Docs Status Manager',
                'url' => 'docstatus',
            ],
        ],
    ],
