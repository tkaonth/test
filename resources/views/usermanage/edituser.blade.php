                        ...
                        <form method="POST" action="{{ route('updateuser', ['id' => $userdata->id]) }}">
                            ...
                            <div>
                                ...
                                <x-input id="name" class="block mt-1 w-full" type="text" name="name"
                                    ...
                                    oninvalid="!this.value || !this.value || this.setCustomValidity('{{ $content_lang['req-name'] }}')" />
                                @error('name')
                            ...
                            <div class="mt-4">
                                ...
                                <x-input id="username" class="block mt-1 w-full" type="text" name="username"
                                    value="{{ $userdata->username }}" required autocomplete="username"
                                    oninvalid="!this.value || !this.value || this.setCustomValidity('{{ $content_lang['req-username'] }}')" />
                                @error('username')
                                    <div class="p-2 mt-1 text-sm text-red-500 rounded-lg bg-red-100" role="alert">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="mt-4">
                                ...
                                <x-input id="password" class="block mt-1 w-full" type="password" name="password"
                                    oninvalid="!this.value || !this.value || this.setCustomValidity('{{ $content_lang['req-password'] }}')" />
                                @error('password')
                                    <div class="p-2 mt-1 text-sm text-red-500 rounded-lg bg-red-100" role="alert">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="mt-4">
                                ...
                                <x-input id="password_confirmation" class="block mt-1 w-full" type="password"
                                    ...
                                    oninvalid="!this.value || !this.value || this.setCustomValidity('{{ $content_lang['req-confirmpassword'] }}')" />
                                ...
                                <select
                                    ...
                                    @foreach ($user_levels as $user_level)
                                        <option value="{{ $user_level->keyword }}" 
                                            {{ $userdata->user_level == $user_level->keyword ? 'selected' : '' }}>
