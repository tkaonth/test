                    ...
                    <div>
                        ...
                        <form method="POST" action="{{ route('addnewcar') }}">
                            ...
                            <div class="flex w-full justify-between mb-2">
                                ...
                                <div class="w-1/4 mr-5">
                                    <x-label for="total_acc_price" value="{{ $content_lang['new-total-acc-price'] }}" />
                                    <x-input id="total_acc_price" class="block mt-1 w-full" type="number" name="total_acc_price"
                                        required autofocus autocomplete="total_acc_price" onchange="sumprice()"
                                ...
                                <div class="w-1/4 mr-5">
                                    ...
                                    <x-input id="car_expenses" class="block mt-1 w-full border-bg-gray-300" type="number"
                                        name="car_expenses" required autofocus autocomplete="car_expenses"
                                        onchange="sumprice()" value="0"
                                        oninvalid="!this.value || this.setCustomValidity('{{ $content_lang['req-car-price'] }}')" />
                                    @error('car_expenses')
                                        <div class="p-2 mt-1 text-sm text-red-500 rounded-lg bg-red-100" role="alert">
                                            {{ $message }}
...
<script>
    function addnewaccform() {
        ...
        div.innerHTML = `<div class="border-2 drop-shadow-sm relative rounded-lg p-3 mb-3">
                                        <div onclick="removeaccessory(this)" class="removeacc absolute right-5 rounded-lg text-red-500 mb-2 cursor-pointer hover:bg-gray-200">
