...
<script>
    ...
    $(document).ready(function() {
        ...
        let oldoptions = {!! json_encode($branchdata->zone) !!};

        for (let i = 0; i < options.length; i++) {
            if (oldoptions.includes(options[i])) {
                $('#selectedzone').append("<option class='bg-white' value='" + options[i] + "'>" + optiontext[i] +
                    "</option>");
            } else {
                $('#selectzone').append("<option class='bg-white' value='" + options[i] + "'>" + optiontext[i] +
                    "</option>");
            }
        }
    });
    ...
    $(document).ready(function() {
        $('#edit_submit').click(function() {
            $("#selectedzone option").prop("selected", true);
        });
    });
</script>
